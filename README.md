...
- `Assets` - scenes, prefabs, models, materials, audio, and gameplay scripts
- `Packages` - Unity package dependencies
- `ProjectSettings` - Unity project settings and version information

## Main Features

- VR grab interaction
- Trash collection and gate progression
- Coral revival system
- Barnacle pull-off interaction
- Turtle waypoint swimming behavior
- Underwater environmental storytelling
